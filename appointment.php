...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    switch ($action) {
        case 'insert':
            $sql = "INSERT INTO Appointments (appointment_id, patient_id, staff_id, room_id, appointment_date, appointment_time, discharge_date) VALUES ('$appointment_id','$patient_id', '$staff_id', '$room_id', '$appointment_date', '$appointment_time', '$discharge_date')";
