...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    switch ($action) {
        case 'insert':
            $sql = "INSERT INTO patients (patient_id, first_name, last_name, date_of_birth, gender, address, phone_number, email, medical_history) VALUES ( '$patient_id', '$first_name', '$last_name', '$date_of_birth', '$gender', '$address', '$phone_number', '$email', '$medical_history')";
            $conn->query($sql);
            break;
